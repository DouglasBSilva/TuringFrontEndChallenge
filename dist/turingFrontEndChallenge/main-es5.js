...
/* harmony import */ var ngx_stripe__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ngx-stripe */ "./node_modules/ngx-stripe/fesm5/ngx-stripe.js");
...
function getAuthServiceConfigs() {
    var config = new angular_6_social_login__WEBPACK_IMPORTED_MODULE_23__["AuthServiceConfig"]([
        {
...
var HttpClientInterceptor = /** @class */ (function () {
    function HttpClientInterceptor(toastr) {
        this.toastr = toastr;
    }
    HttpClientInterceptor.prototype.intercept = function (request, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (event) {
            ...
            _this.toastr.error(data.reason, data.status);
            if (error.error && error.error.error.field) {
                _this.toastr.warning(error.error.error.field, 'Field(s)');
            }
...
var Customer = /** @class */ (function () {
    function Customer(customer_id, name, email, address_1, address_2, city, region, postal_code, country, shipping_region_id, day_phone, eve_phone, mob_phone, credit_card) {
    ...
    Customer.prototype.userCanBuy = function () {
        var can_buy = false;
        can_buy = !!(this.email &&
            this.name &&
            this.address_1 &&
...
var AttributesService = /** @class */ (function () {
    ...
    AttributesService.prototype.get = function () {
...
var CategoriesService = /** @class */ (function () {
    function CategoriesService(client) {
        this.client = client;
    ...
    CategoriesService.prototype.getByDepartmentId = function (id) {
...
var CustomersService = /** @class */ (function () {
    function CustomersService(client, socialAuthService) {
        this.client = client;
        this.socialAuthService = socialAuthService;
        this.base_url = '/customers';
    }
    CustomersService_1 = CustomersService;
    Object.defineProperty(CustomersService.prototype, "user", {
        get: function () {
    ...
    CustomersService.prototype.loginFacebookTuringApi = function (accessToken) {
    ...
    CustomersService.prototype.loginFacebookApi = function () {
        var _this = this;
        return Object(rxjs_internal_compatibility__WEBPACK_IMPORTED_MODULE_8__["fromPromise"])(this.socialAuthService.signIn(angular_6_social_login__WEBPACK_IMPORTED_MODULE_3__["FacebookLoginProvider"].PROVIDER_ID))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(function (userData) {
            localStorage.setItem('facebookToken', userData.token);
            return _this.loginFacebookTuringApi(userData.token);
    ...
    CustomersService.prototype.updateCreditCard = function (credit_card) {
    ...
    CustomersService.prototype.updateAddress = function (user) {
    ...
    CustomersService.prototype.register = function (name, email, password) {
...
var DepartmentsService = /** @class */ (function () {
    function DepartmentsService(client) {
        this.client = client;
        this.base_url = '/departments';
    }
    DepartmentsService.prototype.get = function () {
        return this.client.get('https://backendapi.turing.com' + this.base_url);
    };
...
var OrdersService = /** @class */ (function () {
    function OrdersService(client) {
        this.client = client;
        this.base_url = '/orders';
    }
    OrdersService.prototype.create = function (cart_id, shipping_id, tax_id) {
        if (tax_id === void 0) { tax_id = 2; }
        var params = { cart_id: cart_id, shipping_id: shipping_id, tax_id: tax_id };
        return this.client.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + this.base_url, params);
    };
    OrdersService.prototype.shortDetail = function (id) {
...
var ProductsService = /** @class */ (function () {
    function ProductsService(client) {
        this.client = client;
        this.base_url = '/products';
    }
    ProductsService.prototype.find = function (id) {
        return this.client.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + this.base_url + '/' + id);
    };
    ProductsService.prototype.get = function (page, limit, description_lenght) {
        if (page === void 0) { page = 1; }
        if (limit === void 0) { limit = 20; }
        if (description_lenght === void 0) { description_lenght = 200; }
        var options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('page', page.toString())
    ...
    ProductsService.prototype.getByDepartment = function (page, limit, department_id, description_lenght) {
        if (page === void 0) { page = 1; }
        if (limit === void 0) { limit = 20; }
        if (description_lenght === void 0) { description_lenght = 200; }
        var options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('page', page.toString())
    ...
    ProductsService.prototype.getByCategory = function (page, limit, category_id, description_lenght) {
        if (page === void 0) { page = 1; }
        if (limit === void 0) { limit = 20; }
        if (description_lenght === void 0) { description_lenght = 200; }
        var options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('page', page.toString())
    ...
    ProductsService.prototype.search = function (page, limit, query_string, description_lenght) {
        if (page === void 0) { page = 1; }
        if (limit === void 0) { limit = 20; }
        if (description_lenght === void 0) { description_lenght = 200; }
        var options = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('page', page.toString())
...
var ShippingService = /** @class */ (function () {
    function ShippingService(client) {
        this.client = client;
        this.base_url = '/shipping';
    }
    ShippingService.prototype.find = function (id) {
    ...
    ShippingService.prototype.get = function () {
...
var ShoppingcartService = /** @class */ (function () {
    function ShoppingcartService(client) {
        this.client = client;
        this.base_url = '/shoppingcart';
    }
    ShoppingcartService_1 = ShoppingcartService;
    Object.defineProperty(ShoppingcartService.prototype, "amount", {
        get: function () {
    ...
    ShoppingcartService.prototype.find = function () {
    ...
    ShoppingcartService.prototype.getTotalAmout = function () {
        var _this = this;
        this.client.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api_url + this.base_url + '/totalAmount/' + localStorage.getItem('cart_id'))
            ...
            _this.amount = result.total_amount || 0;
        }, function (error) {
        });
    };
    ShoppingcartService.prototype.add = function (product_id, attributes) {
        var params = {
    ...
    ShoppingcartService.prototype.removeProduct = function (item_id) {
    ...
    ShoppingcartService.prototype.update = function (item_id, quantity) {
        var params = {
            item_id: item_id,
            quantity: quantity
        };
    ...
    ShoppingcartService.prototype.startCart = function () {
        var _this = this;
...
var StripeService = /** @class */ (function () {
    function StripeService(client) {
        this.client = client;
        this.base_url = '/stripe';
    }
    StripeService.prototype.charge = function (stripeToken, order_id, description, amount, currency) {
        if (currency === void 0) { currency = 'USD'; }
        var params = { stripeToken: stripeToken, order_id: order_id, description: description, amount: amount, currency: currency };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(customersService, bsModalRef, bsModalService) {
    ...
    LoginComponent.prototype.loginFacebook = function () {
        var _this = this;
        this.customersService.loginFacebookApi().subscribe(function (result) {
            _this.customersService.user = result.customer;
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(customersService, bsModalRef, bsModalService, toastr) {
        this.customersService = customersService;
        this.bsModalRef = bsModalRef;
        this.bsModalService = bsModalService;
        this.toastr = toastr;
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.password == this.password_copy) {
            this.customersService.register(this.name, this.email, this.password)
                ...
                _this.customersService.user = result.customer;
                localStorage.setItem('accessToken', result.accessToken);
                _this.toastr.success('Successfully registered', 'Success');
                _this.bsModalRef.hide();
            }, function (error) {
                localStorage.setItem('accessToken', '');
            });
...
var CartListComponent = /** @class */ (function () {
    function CartListComponent(shoppingCartService) {
        this.shoppingCartService = shoppingCartService;
        this.onRemoveItem = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    CartListComponent.prototype.alterQuantity = function (add_number, item) {
    ...
    CartListComponent.prototype.removeItem = function (item_id) {
...
var CartComponent = /** @class */ (function () {
    function CartComponent(bsModalRef, bsModalService, shoppingCartService, customersService, orderService) {
        this.bsModalRef = bsModalRef;
        this.bsModalService = bsModalService;
        this.shoppingCartService = shoppingCartService;
        this.customersService = customersService;
    ...
    CartComponent.prototype.tryCheckout = function () {
    ...
    CartComponent.prototype.removeItem = function (item_id) {
        ...
        this.shoppingCartService.removeProduct(item_id)
            .subscribe(function () {
            _this.cart_itens = _this.cart_itens.filter(function (item) { return item.item_id !== item_id; });
        });
    };
    CartComponent.prototype.getItensCart = function () {
        var _this = this;
        this.shoppingCartService.get()
            .subscribe(function (result) {
            _this.cart_itens = result;
        });
    };
...
var CategoryListComponent = /** @class */ (function () {
    ...
    CategoryListComponent.prototype.chooseCategory = function (category_id) {
    ...
    CategoryListComponent.prototype.getCategories = function () {
        ...
        this.categoryService.get()
            .subscribe(function (result) {
            var category_itens_ordered_by_department = [];
            ...
            _this.categories = [];
            _this.categories = category_itens_ordered_by_department;
        }, function (error) {
            console.log(error);
        });
    };
...
var MainPageComponent = /** @class */ (function () {
    function MainPageComponent(cartService, customersService, activedRouter) {
        this.cartService = cartService;
        this.customersService = customersService;
        this.activedRouter = activedRouter;
        this.title = 'turingFrontEndChallenge';
    }
    MainPageComponent.prototype.onSearch = function (text) {
        if (text === void 0) { text = ''; }
    ...
    MainPageComponent.prototype.tryOpenCategory = function (department_id) {
        this.department_id = (this.department_id === department_id ? null : department_id);
        if (this.department_id == null) {
            this.category_id = null;
        }
        var item_id = this.department_id || 0;
        var list_type = item_id > 0 ? 'department' : '';
        this.product_list.setListFilter(list_type, item_id);
    };
    MainPageComponent.prototype.tryFilterByCategory = function (category_id) {
        this.category_id = (this.category_id === category_id ? null : category_id);
        var item_id = this.category_id || 0;
        var list_type = item_id > 0 ? 'category' : 'department';
        this.product_list.setListFilter(list_type, (item_id || this.department_id));
    };
    MainPageComponent.prototype.autoConnectUser = function () {
        var _this = this;
        this.customersService.find()
            .subscribe(function (result) {
            _this.customersService.user = result;
        }, function (error) {
            localStorage.setItem('accessToken', '');
        });
    };
    MainPageComponent.prototype.autoConnectFacebook = function (facebookToken) {
        var _this = this;
...
var NavBarComponent = /** @class */ (function () {
    function NavBarComponent(departmentService) {
    ...
    NavBarComponent.prototype.search = function (text) {
        this.active_department = 0;
        this.onSearch.emit(text);
    };
    NavBarComponent.prototype.openCategories = function (department_id) {
        this.active_department = (this.active_department === department_id ? 0 : department_id);
        this.onTryOpenCategories.emit(department_id);
    };
    NavBarComponent.prototype.setDepartmentsNames = function () {
        var _this = this;
...
var SecondNavBarComponent = /** @class */ (function () {
    function SecondNavBarComponent(bsModalService, customersService, cartService) {
        this.bsModalService = bsModalService;
        this.customersService = customersService;
        this.cartService = cartService;
    }
    SecondNavBarComponent.prototype.openLoginModal = function () {
        this.bsModalService.show(_auth_login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"]);
    };
    SecondNavBarComponent.prototype.openUserDetail = function () {
...
var ListReviewsComponent = /** @class */ (function () {
    function ListReviewsComponent() {
    }
    ListReviewsComponent.prototype.ngOnInit = function () {
    };
...
var ProductsDetailCompleteComponent = /** @class */ (function () {
    function ProductsDetailCompleteComponent(productService, activatedRouter, attributesService, cartService) {
    ...
    ProductsDetailCompleteComponent.prototype.formatAttributes = function (attributes) {
        var _this = this;
        var index = -1;
        var attribute_name = '';
        attributes.forEach(function (attribute) {
            if (attribute.attribute_name != attribute_name) {
                index++;
                _this.attributes[index] = [];
                attribute_name = attribute.attribute_name;
                _this.attributes_selected[index] = attribute.attribute_value;
            }
            _this.attributes[index].push(attribute);
        });
    };
    ProductsDetailCompleteComponent.prototype.getAttributes = function () {
        var _this = this;
        this.attributesService.findByProductId(this.product_id)
            .subscribe(function (result) {
            _this.formatAttributes(result);
        }, function (error) {
        });
    };
    ProductsDetailCompleteComponent.prototype.getProduct = function () {
        var _this = this;
        this.productService.find(this.product_id)
            .subscribe(function (result) {
            _this.product = result;
            _this.selected_image = _this.product.image;
        }, function (error) {
        });
    };
    ProductsDetailCompleteComponent.prototype.addToCart = function () {
        var _this = this;
        this.cartService.add(this.product_id, this.attributes_selected.join(','))
            .subscribe(function (result) {
            _this.cartService.getTotalAmout();
        }, function (error) {
        });
    };
    ProductsDetailCompleteComponent.prototype.ngOnInit = function () {
        this.getProduct();
        this.getAttributes();
    };
    ProductsDetailCompleteComponent.ctorParameters = function () { return [
    ...
    return ProductsDetailCompleteComponent;
}());
...
var ProductsDetailComponent = /** @class */ (function () {
    function ProductsDetailComponent(bsModalService) {
        this.bsModalService = bsModalService;
    }
    ProductsDetailComponent.prototype.openProduct = function () {
        var initialState = { product_id: this.product.product_id };
        this.bsModalService.show(_products_detail_complete_products_detail_complete_component__WEBPACK_IMPORTED_MODULE_3__["ProductsDetailCompleteComponent"], { initialState: initialState, class: 'max-w-1200' });
    };
...
var ProductsListComponent = /** @class */ (function () {
    function ProductsListComponent(productsService, activeRouter) {
        var _this = this;
        ...
        this.setListFilter = function (list_type, item_id) {
            if (list_type === void 0) { list_type = ''; }
            if (item_id === void 0) { item_id = 0; }
            _this.list_type = list_type;
            _this.filter_id = item_id;
            _this.getProducts();
        };
    }
    ProductsListComponent.prototype.getProductsByDepartment = function (page) {
        var _this = this;
        if (page === void 0) { page = 1; }
        this.productsService.getByDepartment(page, this.products_per_page, this.filter_id).subscribe(function (result) {
            _this.page = page;
            _this.products_list = result.rows;
            _this.total_products = result.count;
            _this.total_pages = Math.ceil((_this.total_products / _this.products_per_page));
            _this.page_sent = page;
        });
    };
    ProductsListComponent.prototype.alterPage = function (event) {
        event.preventDefault();
        if (Object(rxjs_internal_compatibility__WEBPACK_IMPORTED_MODULE_3__["isNumeric"])(event.target.value)) {
            var actual_page = event.target.value > this.total_pages ? this.page_sent : event.target.value;
    ...
    ProductsListComponent.prototype.sumPage = function (sum) {
        this.page = this.page + sum > this.total_pages || this.page + sum < 1 ? this.page : this.page + sum;
        if (this.page != this.page_sent) {
            this.getProducts(this.page);
        }
    };
    ProductsListComponent.prototype.getProductsByCategory = function (page) {
        var _this = this;
        if (page === void 0) { page = 1; }
        this.productsService.getByCategory(page, this.products_per_page, this.filter_id).subscribe(function (result) {
            _this.page = page;
            _this.products_list = result.rows;
            _this.total_products = result.count;
            _this.total_pages = Math.ceil((_this.total_products / _this.products_per_page));
    ...
    ProductsListComponent.prototype.getProductsAll = function (page) {
        var _this = this;
        if (page === void 0) { page = 1; }
        this.productsService.get(page, this.products_per_page).subscribe(function (result) {
            _this.page = page;
            _this.products_list = result.rows;
            _this.total_products = result.count;
            _this.total_pages = Math.ceil((_this.total_products / _this.products_per_page));
    ...
    ProductsListComponent.prototype.getProductsBySearch = function (page) {
        var _this = this;
        if (page === void 0) { page = 1; }
        this.productsService.search(page, this.products_per_page, this.search_value).subscribe(function (result) {
            _this.page = page;
            _this.products_list = result.rows;
            _this.total_products = result.count;
            _this.total_pages = Math.ceil((_this.total_products / _this.products_per_page));
    ...
    ProductsListComponent.prototype.getProducts = function (page) {
        if (page === void 0) { page = 1; }
    ...
    ProductsListComponent.prototype.setSearchText = function (text) {
        if (text === void 0) { text = ''; }
        if (text.length > 0) {
...
var CheckShippingAddressComponent = /** @class */ (function () {
    function CheckShippingAddressComponent(customersService, shippingService, bsModalRef, bsModalService) {
        this.customersService = customersService;
    ...
    CheckShippingAddressComponent.prototype.confirmShippingInformation = function () {
        this.bsModalService.show(_payment_form_payment_form_component__WEBPACK_IMPORTED_MODULE_6__["PaymentFormComponent"]);
        this.bsModalRef.hide();
    };
    CheckShippingAddressComponent.prototype.checkUser = function () {
    ...
    CheckShippingAddressComponent.prototype.getShippings = function () {
        var _this = this;
        this.shippingService.get()
            .subscribe(function (result) {
            _this.shippings = result;
        });
    };
    CheckShippingAddressComponent.prototype.ngOnInit = function () {
        if (this.checkUser()) {
            this.getShippings();
    ...
    CheckShippingAddressComponent.ctorParameters = function () { return [
    ...
    return CheckShippingAddressComponent;
}());
...
var PaymentFormComponent = /** @class */ (function () {
    function PaymentFormComponent(fb, stripeService, shoppingCartService, orderService, customersService, bsModalRef, apiStripeService, toastr) {
        this.fb = fb;
    ...
    PaymentFormComponent.prototype.createOrder = function (stripe_token) {
        var _this = this;
        this.orderService.create(localStorage.getItem('cart_id'), this.customersService.user.shipping_region_id)
            .subscribe(function (result) {
            _this.orderService.shortDetail(result.orderId)
                .subscribe(function (order) {
                // Api amount value is retorning like  Float string. and the Stripe Api need a integer
                var amount = parseInt((parseFloat(order.total_amount) * 100).toFixed(0), 10);
                _this.apiStripeService.charge(stripe_token, order.order_id, order.name, amount)
                    .subscribe(function (success) {
                    _this.toastr.success('Your order was concluded with success', 'Success');
    ...
    PaymentFormComponent.prototype.buy = function () {
        var _this = this;
        ...
        this.stripeService
            ...
            .subscribe(function (result) {
            if (result.token) {
                _this.createOrder(result.token.id);
...
var DetailUserComponent = /** @class */ (function () {
    function DetailUserComponent(customersService, shippingService, bsModalRef) {
        this.customersService = customersService;
        this.shippingService = shippingService;
        this.bsModalRef = bsModalRef;
        this.user_shipping = 'No shipping Region Selected';
    ...
    DetailUserComponent.prototype.updateCreditCard = function () {
        var _this = this;
        this.customersService.updateCreditCard(this.local_user.credit_card)
            .subscribe(function (result) {
            _this.customersService.user = result;
            _this.closeCreditCard();
        });
    };
    DetailUserComponent.prototype.logout = function () {
        if (this.customersService.logout()) {
            this.bsModalRef.hide();
        }
    };
    DetailUserComponent.prototype.updateAddress = function () {
        var _this = this;
    ...
    DetailUserComponent.prototype.closeCreditCard = function (edited) {
    ...
    DetailUserComponent.prototype.closeAddress = function (edited) {
        if (edited === void 0) { edited = false; }
        if (!edited) {
            this.local_user = JSON.parse(JSON.stringify(this.customersService.user));
        }
    ...
    DetailUserComponent.prototype.checkUser = function () {
        var user_active = false;
        if (this.customersService.user) {
            if (this.customersService.user.name) {
                user_active = true;
    ...
    DetailUserComponent.prototype.getShippings = function () {
        var _this = this;
        this.shippingService.get()
            .subscribe(function (result) {
            _this.shippings = result;
    ...
    DetailUserComponent.ctorParameters = function () { return [
        { type: _services_customers_service__WEBPACK_IMPORTED_MODULE_2__["CustomersService"] },
